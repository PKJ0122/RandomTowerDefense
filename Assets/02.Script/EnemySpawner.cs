...
public class EnemySpawner : MonoBehaviour
{
    ...
    WaveDate _waveDate; //Resources폴더에 있는 웨이브데이터
    ...
    void Awake()
    {
        ...
        _waveDate = Resources.Load<WaveDate>("WaveData");
    ...
    private void EnemySpawn(int round)
    {
        ...
        if (r == 0)
            StartCoroutine(C_BossEnemySpawn(_waveDate.HpDates[round]));
        else
            StartCoroutine(C_NomalEnemySpawn(_waveDate.HpDates[round]));
    }
